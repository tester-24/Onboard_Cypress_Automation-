...
describe('Onboard', () => {
    it('Complete_All', () => {
     ...
     cy.get('.client-gust-ob1 > :nth-child(3) > .slds-checkbox_button-group').click()
     cy.wait(500)
 ...
 it('Complete_AOF_EKYC_Today', () => 
    ...
    it('Complete_MOD_Manual_yesterday', () => 
        {
          cy.Loginflow()
         //click on complete tab
         cy.get('.client-gust-ob1 > :nth-child(3) > .slds-checkbox_button-group').click()
        //  cy.xpath('/html/body/app-root/app-dashboard/div/main/div/app-clientsurcgenerated/div[2]/div/div[1]/div[2]/div[1]/div/label/kendo-daterange').click()
          ...
          // click on yesterday
          cy.get('.client-gust-ob5 > :nth-child(3) > .slds-checkbox_button-group').click()
     ...
     cy.get('.client-gust-ob1 > :nth-child(3) > .slds-checkbox_button-group').click()
           ...
           // cy.get('.col-md-3 > .form-control').click({force:true})
          // click on DLLR
            cy.get('.client-gust-ob3 > :nth-child(4) > .slds-checkbox_button-group').click()
            // click on manual
            cy.get('.client-gust-ob4 > :nth-child(3) > .slds-checkbox_button-group').click({force:true})
            // click on 7 DAYS
          ...
          it('complete_DUCK_EKYC_30DAYS', () => 
            {
             ...
             // cy.get('.col-md-3 > .form-control').click({force:true})
              ...
              // click on ekyc
              cy.get('.client-gust-ob4 > :nth-child(2) > .slds-checkbox_button-group').click()
            // click on 30 DAYS
            cy.get('.client-gust-ob5 > :nth-child(5) > .slds-checkbox_button-group').click()
             //cy.get('.client-gust-ob5 > :nth-child(4) > .slds-checkbox_button-group').click({force:true})
              if(cy.xpath('/html/body/app-root/app-dashboard/div/main/div/app-clientsurcgenerated/div[2]/div/div[3]/kendo-grid/div/kendo-grid-list/div/div[1]/table/tbody/tr').should('have.length.above',0))
                {
                     cy.log('data found')
