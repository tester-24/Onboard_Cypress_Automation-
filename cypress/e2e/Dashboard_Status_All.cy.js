...
describe('Onboard', () => {
    ...
    cy.Loginflow2()
     //click on status
     cy.wait(3500)
     cy.get(':nth-child(1) > :nth-child(1) > .slds-checkbox_button-group').click({force:true})
     //click on calender
     cy.wait(1000)
    ...
    it('Status_All_AOF_EKYC_Today', () => {
      cy.Loginflow2()
       ...
       it('Status_All_MOD_MANUAL_YESTERDAY', () => {
         cy.Loginflow2()
         //click on status 
         cy.wait(3500)
         cy.get(':nth-child(1) > :nth-child(1) > .slds-checkbox_button-group').click({force:true})
       ...
       it('Status_All_Duck_EKYC_30DAYS', () => {
         cy.Loginflow2()
        // click on status 
        cy.get(':nth-child(1) > :nth-child(1) > .slds-checkbox_button-group').click({force:true})
         //click on calender
         ...
         it('Satus_All_MTF_Manual_Yesterday', () => {
            cy.Loginflow2()
           // click on Status 
           cy.get(':nth-child(1) > :nth-child(1) > .slds-checkbox_button-group').click({force:true})
           //click on calender
