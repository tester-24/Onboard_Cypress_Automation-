...
describe('Onboard', () => {
    it('Underverification_All', () => {
     cy.Loginflow1()
     //click on all 
     cy.get('.col_wrap_first_cward > :nth-child(1) > .slds-checkbox_button-group').click()
     //click on calender
    ...
    it('Underverification_All_AOF_EKYC_Today', () => {
        cy.Loginflow1()
        //click on all 
        cy.get('.col_wrap_first_cward > :nth-child(1) > .slds-checkbox_button-group').click()
        //click on calender
       ...
       it('Underverification_All_MOD_MANUAL_YESTERDAY', () => {
        cy.Loginflow1()
        //click on all 
        cy.get('.col_wrap_first_cward > :nth-child(1) > .slds-checkbox_button-group').click()
        //click on calender
       ...
       it('Underverification_All_DLLR_ALL_7DAYS', () => {
        cy.Loginflow1()
        //click on all 
        cy.get('.col_wrap_first_cward > :nth-child(1) > .slds-checkbox_button-group').click()
        //click on calender
       ...
       it('Underverification_All_Duck_EKYC_30DAYS', () => {
         cy.Loginflow1()
        // click on all 
         cy.get('.col_wrap_first_cward > :nth-child(1) > .slds-checkbox_button-group').click()
         //click on calender
         ...
         it('Underverification_All_MTF_Manual_Yesterday', () => {
            cy.Loginflow1()
           // click on all 
            cy.get('.col_wrap_first_cward > :nth-child(1) > .slds-checkbox_button-group').click()
            //click on calender
