...
describe('Onboard', () => {
    it('Underverification_Underverification_All', () => {
     cy.Loginflow1()
     //click on Underverification  
     cy.get('.col_wrap_first_cward > :nth-child(3) > .slds-checkbox_button-group').click()
     //click on calender
    ...
    it('Underverification_Underverification_AOF_EKYC_Today', () => {
        cy.Loginflow1()
        //click on Underverification 
        cy.get('.col_wrap_first_cward > :nth-child(3) > .slds-checkbox_button-group').click()
        //click on calender
       ...
       it('Underverification_Underverification_MOD_MANUAL_YESTERDAY', () => {
        cy.Loginflow1()
        //click on Underverification 
        cy.get('.col_wrap_first_cward > :nth-child(3) > .slds-checkbox_button-group').click()
        //click on calender
       ...
       it('Underverification_Underverification_DLLR_ALL_7DAYS', () => {
        cy.Loginflow1()
        //click on Underverification
        cy.get('.col_wrap_first_cward > :nth-child(3) > .slds-checkbox_button-group').click()
        //click on calender
       ...
       it('Underverification_Underverification_Duck_EKYC_30DAYS', () => {
         cy.Loginflow1()
        // click on Received 
         cy.get('.col_wrap_first_cward > :nth-child(3) > .slds-checkbox_button-group').click()
         //click on calender
         ...
         it('Underverification_Underverification_MTF_Manual_Yesterday', () => {
            cy.Loginflow1()
           // click on Underverification
            cy.get('.col_wrap_first_cward > :nth-child(3) > .slds-checkbox_button-group').click()
            //click on calender
